 ...
 */
//** Termalní Ochrana Poudmožno nikdy nevipínat!!
...
#define DELTA
  ...
  #define DELTA_SEGMENTS_PER_SECOND 160 //!original 200
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 397.0 }  
//! 397.1 for Titan extruder ! default steps per unit for Kossel (GT2, 20 tooth)
...
#define Y_PROBE_OFFSET_FROM_EXTRUDER 0     // Y offset: -front +behind [the nozzle]
  ...
  //! Predator have -16.1 !!
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -16.1  //! Z offset: -below +above  [the nozzle]
...
//! Vychozi 15 zkusim test s 10 možna se to da snižit na 5 ?!
//Todo - 5 je ok ale možno snižit ješte o kousiček cca na 0 nebo 2 !!
...
//! Pauza pro nasazeni a sundani Probe
...
// @section machine
//**! Krokove Motory - Smer toceni
// Invert the stepper direction. Change (or reverse the motor connector) if an axis goes the wrong way.
#define INVERT_X_DIR true //!true TMC 2208
#define INVERT_Y_DIR true //!true TMC 2208
#define INVERT_Z_DIR true //!true TMC 2208

// @section extruder

// For direct drive extruder v9 set to true, for geared extruder set to false.
#define INVERT_E0_DIR false //! false pro Titan Extruder + TMC 2208
...
// @section homing
//! Žadny pohyb dokud nebude tiskarna zhomovana !! 
...
//! M503 - read parameters from EEPROM
//
...
#define PREHEAT_3_LAVEL       "Material"
