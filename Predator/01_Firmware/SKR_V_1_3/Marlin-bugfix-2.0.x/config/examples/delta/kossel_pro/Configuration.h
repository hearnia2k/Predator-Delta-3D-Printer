...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_CALIBRATION_RADIUS 370.0 // (mm)
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 9000, 9000, 9000, 4800 }
 ...
 */
#define Z_PROBE_OFFSET_FROM_EXTRUDER -15.69  // Increase this if the first layer is too thin (remember: it's a negative number so increase means closer to zero).
// Certain types of probes need to stay away from edges
#define MIN_PROBE_EDGE 10

// X and Y axis travel speed (mm/m) between probes
#define XY_PROBE_SPEED 2000 //** default 8000
