...
#define TEMP_SENSOR_CHAMBER -1 //! original 0
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //! Anycubic Predator - run 'M106 S255' & 'M303 E0 C10 S200'
  //** Predator má stejné
  #define DEFAULT_Kp 22.36
  #define DEFAULT_Ki 1.63
  #define DEFAULT_Kd 76.48

  // Anycubic Linear+ - run 'M106 S255' & 'M303 E0 C10 S200'
  //#define DEFAULT_Kp 22.36
  //#define DEFAULT_Ki 1.63
  //#define DEFAULT_Kd 76.48
...
#define Y_PROBE_OFFSET_FROM_EXTRUDER 0     // Y offset: -front +behind [the nozzle]
  ...
  //! Predator have -16.1 or -16.0 depend on hotend  !!
  //! Linear+ have -16.0 but it depends on build 
...
#define INVERT_X_DIR true //!true TMC 2208 For Predy // Depends on motor wiring
#define INVERT_Y_DIR true //!true TMC 2208 For Predy
#define INVERT_Z_DIR true //!true TMC 2208 For Predy 
// @section extruder
...
//! Predator Bedi bad mouted need maybe ofset x-5 or -3
...
//! IK- Test LED stavu pro hotend.. potreba otestovat
 ...
 *
 */
//!IK - test pro RGB led na display
#define RGB_LED
//#define RGBW_LED

//!IK - dodefinování pinu pro RGB na display
